...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"> 게시글 상세 보기 페이지 </h1>
	</div>	<!-- .col-lg-12 end -->
</div> <!-- .row end  -->
					...
					<div>
						<div class="header">
							<strong class="primary-font">user00</strong>
								<small class="pull-right text-muted">2024-8-28 16:38 </small>											
						</div>
							<p>Good job !!</p>
					</div>
				</li> <!-- end reply -->
				</ul> <!-- ./end ul -->				
			</div>	<!-- /.paner .chat-panel -->
...
<script type="text/javascript" src="/resources/js/reply.js" ></script> <!-- /* 외부 파일 include 용  */ -->
	...
	$(document).ready(function () {
		...
		function showList(page) {
			...
			replyService.getList({bno:bnoValue, page: page|| 1 }, function(replyCnt, list) {
				...
				if(page == -1) {
					pageNum = Math.ceil(repltCnt/10.0);
					showList(pageNum);
					return;
				}// if(page) 종료
...
var bnoValue = '<c:out value="${board.bno}"/>' ;	// 게시물 상세 보기에 있는 게시물 번호를 변수에 넣음
	...
	replyService.add(
			{reply:"JAVA Script Test", replyer:"ajax", bno:bnoValue}, // json으로 더미데이터 생성
			function(result) {
				alert("결과 : " + result);	
			}
		);	
